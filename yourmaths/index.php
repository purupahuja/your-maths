...
<html lang="en">
  <head>
    ...
    <title>Sintaks | Learn the STEM of Knowledge</title>
   ...
   <body data-spy="scroll" data-target=".navbar-collapse" >
       ...
       <div class="s2" style="background-color: #fff">
            ...
            <div class="container resum">
                ...
                <p style="color:white">It's completely free!</p>
                    <br><br>
        <form class="marginTop" method="post">
          <div class="form-group nam n2 col-md-6">
          ...
          <div class="form-group nam n1 col-md-6">
          ...
          <input type="submit" name="submit" value="Sign Up" class="sub btn btn-success btn-lg marginTop"/>
                ...
                <br>
                    <br>
                <br>
                <p class="copy">Copyright &copy; Sintaks 2016</p>
                </div>
           </div></div>
    </body> 
</html>